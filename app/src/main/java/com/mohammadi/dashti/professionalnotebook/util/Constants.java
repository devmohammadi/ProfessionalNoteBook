...
public class Constants {
    ...
    public static Boolean LOGIN_FRAGMENT = false;
    ...
    public static String LESSON = PREFIX_LINK + "category_lesson.png?alt=media&token=c95b24c1-08bb-419b-a455-9edcc26331e4";
    public static String MOVIE = PREFIX_LINK + "category_movie.png?alt=media&token=d102555d-4277-45eb-bfd7-7e14311ebf53";
    public static String MUSIC = PREFIX_LINK + "category_music.png?alt=media&token=0838b548-de55-4764-a276-4c6e98541f8a";
    public static String BUY = PREFIX_LINK + "category_buy.png?alt=media&token=5ae72e11-893d-4fba-b85d-89d547eae56c";
    public static String OTHER = PREFIX_LINK + "category_other.png?alt=media&token=b0d4bd87-e804-4772-a7b3-fb7f744792c5";
}
